...
function populateParameters(fromRes, toRes) {
  ...
  {
    try {
      parameters.uniCompilerVersionCode = parseFloat("4.65");
      parameters.uniRuntimeVersionCode = parseFloat("4.65");
    } catch (error) {
    }
  }
...
function initRuntimeSocketService() {
  const hosts = "192.168.1.101,127.0.0.1,172.20.128.1";
  const port = "8090";
  const id = "mp-weixin_-NVBaI";
